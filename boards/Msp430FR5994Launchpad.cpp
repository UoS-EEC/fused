...
int sc_main(int argc, char *argv[]) {
  ...
  /* ------ Physical Components and Signals ------ */
  // Headers (pin multiplexing?)
  // Push Buttons (external event dispatcher?)
  // LEDs
  // Supercap
  // MicroSD Connector
  // LF Crystal
  ...
  // Print microcontroller memory map
  ...
  /* ------ Virtual Components and Signals ------ */
  // Energy
